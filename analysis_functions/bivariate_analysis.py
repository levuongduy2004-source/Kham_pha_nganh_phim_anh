...
class NumericalVsNumericalAnalysis(BivariateAnalysisStrategy):
    def analyze(self, df: pd.DataFrame, feature1: str, feature2: str, option: str):
        """
...
class BivariateAnalyzer:
    ...
    def execute_analysis(self, df: pd.DataFrame, feature1: str, feature2: str, option: str):
        """
        ...
        """
        self._strategy.analyze(df, feature1, feature2, option)
